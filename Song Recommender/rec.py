...
if __name__ == "__main__":
    ...
    user_artists = load_user_artists(Path("C:/Users/Aashu/Downloads/SongRec/lastfm_user_scrobbles.csv"))
    user_artists=(bm25_weight(user_artists, K1=100, B=0.8)).tocsr()
    ...
    artists, scores = recommender.recommend(78, user_artists, n=5)
